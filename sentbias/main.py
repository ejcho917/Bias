...
KORBERT_VERSIONS = ['/content/SEAT/sentbias/003_bert_eojeol_pytorch'] # the folder has to be in /sentbias (same folder as main.py) 
...
def handle_arguments(arguments):
    ...
    korbert_group.add_argument('--korbert_version', type=str, choices=KORBERT_VERSIONS,
                            help="Version of KORBERT to use.", default='/content/SEAT/sentbias/003_bert_eojeol_pytorch')
